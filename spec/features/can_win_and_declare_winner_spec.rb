...
describe Tictactoe_jules do
  ...
  it 'Can win diagonally falling' do
    allow(@game_controller.tictactoe_jules.in_out.input).to receive(:gets).and_return('9', '2', '5', '3', '1', '4', '6', '7', '8')
    @game_controller.go
  ...
  it 'Can win diagonally rising' do
    allow(@game_controller.tictactoe_jules.in_out.input).to receive(:gets).and_return('9', '5', '2', '7', '1', '4', '6', '3', '8')
    @game_controller.go
  ...
  it 'Can win a row' do
    allow(@game_controller.tictactoe_jules.in_out.input).to receive(:gets).and_return('9', '1', '7', '2', '6', '3', '4', '5', '8')
    @game_controller.go
  ...
  it 'Can win a column' do
    allow(@game_controller.tictactoe_jules.in_out.input).to receive(:gets).and_return('1', '2', '4', '5', '7', '8', '3', '6', '9')
    @game_controller.go
    expect(@game_controller.tictactoe_jules.turn_count).to eq 5
    expect(@game_controller.tictactoe_jules.winner).to be true
  end
  ...
  it 'Can win with the second column' do
    allow(@game_controller.tictactoe_jules.in_out.input).to receive(:gets).and_return('8', '1', '5', '4', '2', '6', '7', '3', '9')
    @game_controller.go
    expect(@game_controller.tictactoe_jules.turn_count).to eq 5
    expect(@game_controller.tictactoe_jules.winner).to be true
  end
