...
describe Tictactoe_jules do
  ...
  it 'Win with row 4x4' do
    ...
    allow(game_controller.tictactoe_jules.in_out.input).to receive(:gets).and_return('9', '2', '5', '3', '8', '4', '6', '1')
    game_controller.go
  ...
  it 'Win with column 5x5' do
    ...
    tictactoe_jules = Tictactoe_jules.new(@in_out, @player_x, @player_o, board)
    game_controller = Game_controller.new(tictactoe_jules)
    allow(game_controller.tictactoe_jules.in_out.input).to receive(:gets).and_return('1', '2', '6', '5', '11', '12', '21', '17', '16', '22')
    game_controller.go
    expect(game_controller.tictactoe_jules.winner).to be true
  end
  ...
  it 'Win with column 7x7' do
    ...
    tictactoe_jules = Tictactoe_jules.new(@in_out, @player_x, @player_o, board)
    game_controller = Game_controller.new(tictactoe_jules)
    allow(game_controller.tictactoe_jules.in_out.input).to receive(:gets).and_return('1', '2', '9', '5', '17', '12', '25', '18', '33', '22', '41', '30', '49')
    game_controller.go
    expect(game_controller.tictactoe_jules.winner).to be true
  end
end
